        ...
        <html lang="en" xml:lang="en">
            <head>
                <title>
                    ...
                    on your browsers tab--> DCHM Template: Reading Text </title>
                                    ...
                                    <article>
                                        ...
                                        <img class="thumbnail">
                                            ...
                                            <xsl:attribute name="src">
                                                <xsl:value-of
                                                  select="//tei:surface[@xml:id = substring-after($facs, '#')]/tei:figure/tei:graphic[2]/@url"
                                                />
                                            </xsl:attribute>
                                            <xsl:attribute name="title">
                                                <xsl:value-of
                                                  select="//tei:surface[@xml:id = substring-after($facs, '#')]/tei:figure/tei:label"
                                                />
                                            </xsl:attribute>
